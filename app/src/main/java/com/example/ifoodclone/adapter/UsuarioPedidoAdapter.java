...
public class UsuarioPedidoAdapter extends RecyclerView.Adapter<UsuarioPedidoAdapter.MyViewHolder> {
    ...
    public UsuarioPedidoAdapter(List<Pedido> pedidoList, OnClickListener onClickListener) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (pedido.getItemPedidoList().size() > 1) {
            StringBuilder itensAMais = new StringBuilder()
                    .append("mais ")
                    .append(pedido.getItemPedidoList().size() - 1)
                    .append(" itens");
            holder.text_mais_itens.setText(itensAMais);
        ...
        holder.btn_ajuda.setOnClickListener(v -> {
            onClickListener.OnClick(pedido, 0);
        });
        holder.btn_detalhes.setOnClickListener(v -> {
            onClickListener.OnClick(pedido, 1);
        });
    }
        ...
        empresaRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if (empresa != null) {
                        holder.text_nome_empresa.setText(empresa.getNome());
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView text_nome_empresa;
        TextView text_status_pedido;
        TextView text_data_pedido;
        TextView text_qtd_item_pedido;
        TextView text_nome_item_pedido;
        TextView text_mais_itens;
        Button btn_ajuda;
        Button btn_detalhes;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            text_nome_empresa = itemView.findViewById(R.id.text_nome_empresa);
